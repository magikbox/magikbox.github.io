    ...
    <div>
      <section className="py-5 mb-5 d-lg-none color-azure">
        <div className="container-fluid">
          <h2 className="font-xl-l  text-center raleway-extrabold mb-4 text-dark ">
            {work.heading}
          </h2>

          <Slider
            {...settings}
            className="row raleway-extrabold text-white text-center custom-controls-dark"
          >
      ...
      <section className="py-5 mb-5 color-azure d-none d-lg-block text-white">
        <div className="container text-center">
          <h2 className="font-xl-l raleway-extrabold mb-4 text-dark">
            {work.heading}
          </h2>
