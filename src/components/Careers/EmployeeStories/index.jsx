  ...
  return (
    <section className="gray-bg py-5">
      ...
      <div className="container employee-stories">
        ...
        <p
          className="d-none d-md-block font-xl-x text-center text-green neosans-regular pt-5 pb-2
                    "
        >
          Employee Stories
        </p>
        <div className="row d-none d-md-block pb-5">
          <div
            className="col-md-12 px-0 main-carousel"
            style={{ boxShadow: "-25px 25px #009944" }}
          >
            <div
              id="impactSlider"
            ...
            >
              ...
              <div className="carousel-inner">
                {employeeStories.data.map((carouselItem, key) => (
        ...
        >
          <div className="carousel-inner">
            {employeeStories.data.map((carouselItem, key) => (
              <MobileCarouselItem data={carouselItem} key={key} />
            ))}
          </div>
          ...
          >
            <i
              className="fa fa-chevron-left fa-3x p-2 indicators"
              aria-hidden="true"
            />
          ...
          >
            <i
              className="fa fa-chevron-right fa-3x p-2 indicators"
              aria-hidden="true"
            />
