            ...
            (searchResult.options.length > 0 ? (
              <React.Fragment>
                <div
                  ...
                  style={{}}
                >
                  <h6 className="text-left bg-white-hover-gray border-0 py-2 col-12 scroll ">
                    Oops! We couldn't find any jobs titled '{
                      this.props.inputText
                    }' in {this.props.locationName}. Check out our other
                    locations.
                  </h6>
              ...
              <React.Fragment>
                <h6 className="text-left bg-white-hover-gray border-0 py-2 col-12 scroll">
                  Oops! We couldn't find any jobs titled '{this.props.inputText}'
