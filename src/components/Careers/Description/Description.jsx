...
const Description = (props) => {
  ...
  return (
    <div className="py-5 my-5 py-md-2 my-md-0">
      <SEO title={"GOJEK Careers: " + job.text} description={job.text} />
      ...
      {job.lists[0] !== undefined && (
        <React.Fragment>
          ...
          <div className=" description-font text-dark col-12 pl-0">
            <ul className="pl-3">
              <div className=" job-points">{Parser(job.lists[0].content)}</div>
            </ul>
          </div>
        </React.Fragment>
      )}
      {job.lists[0] !== undefined && (
        <React.Fragment>
          ...
          <div className=" description-font text-dark col-12 pl-0 pb-5 pb-md-0">
            <ul className="pl-3">
              <div className=" job-points">{Parser(job.lists[1].content)}</div>
            </ul>
          </div>
        </React.Fragment>
      )}
