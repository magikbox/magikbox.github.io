    ...
    axios
      ...
      .then(response => {
        for (let i = 0; i < response.data.length; i++) {
          ...
          if (locationCount === 0) {
            if (response.data[i].categories.location !== undefined) {
              if (
                response.data[i].categories.location !== "Manila" &&
                response.data[i].categories.location !== "Depok" &&
                response.data[i].categories.location !== "Malang" &&
                response.data[i].categories.location !== "Serang"
              ) {
