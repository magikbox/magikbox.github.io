          ...
          <div className="d-flex align-items-center justify-content-center h-100">
            <picture>
              <source
                ...
                srcSet="../../images/gomakeimpact/impact-on-scale-banner-mobile.png"
              />
              <img
                className="img-fluid"
            ...
            <div className="text-block text-white text-center pt-5 mt-5 position-absolute">
              ...
              <p
                className="roboto-regular px-3 px-md-0 font-md"
        ...
        <section className="position-relative" id="about">
          ...
          <div className="gomake-impact-bg who-we-are text-white py-5">
            <div className="row justify-content-center mx-0 py-md-5 py-0">
              <p
                className="text-block text-center roboto-bold px-3 px-md-0 font-md"
          ...
          <div className="d-flex align-items-center justify-content-center">
            <picture>
              <source
                className="relative-position"
                media="(max-width: 425px)"
                srcSet="../../images/gomakeimpact/test-mobile.png"
              />
              <img
                className="img-fluid"
        ...
        <section id="jobs">
          ...
          <div className="job-openings pt-5" id="super-jobs">
            <div className="row mx-0 mb-4 justify-content-center">
              <p
                className="text-block text-dark text-center roboto-regular  px-3 px-md-0 font-md"
                style={{ letterSpacing: '0.8px' }}
              >
                We’re looking for Engineers, Data Scientists, Product Managers,
                Designers and Marketers who have a passion to improve lives and
                contribute to our social mission. If this is of interest, check
                out our openings and apply right now!
              </p>
            </div>
            <OpenPositions
              team=""
