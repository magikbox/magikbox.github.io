  ...
  render() {
    return (
      <Layout location={this.props.location}>
        <SEO
          title="Why we ask for code- GO-JEK Product + Tech "
          description="Why we ask for code- GO-JEK Product + Tech "
        />
            ...
            <div className="row">
              <div className="heading col-md-12 px-md-0">
                ...
                <h6 className="roboto-regular pb-4 font-md ">
                  When your ideal candidates make up just 0.5% of the job
                  market, code is the best criteria to hire the right people.
                </h6>
              </div>
              <div className="px-4 px-md-0  ">
                ...
                <div className="font-md roboto-regular text-dark">
                  ...
                  <p className="pt-2 ">
                    ...
                    quarter, zeroing in on this 0.5% becomes hard. Extremely
                    hard.
                  </p>
                  <blockquote className="blockquote font-md">
                    <p className="pt-2 roboto-bold">
                      ...
                      250-strong engineering team has scaled 18+ products to
                      over a 100 million monthly orders sustainably. Lean
                      Engineering is something we take very seriously.
                    </p>
                  </blockquote>

                  <p className="pt-2">
                    Asking applicants to solve a simple programming problem is a
                    logical step in the filtration process. Our take home
                    problem is, quite literally, at the complexity of a high
                    school CLI programming exercise. We don’t require any
                    frameworks or libraries to be used outside of unit testing.
                    We expect standard Open Source conventions including git,
                    file and dir naming, dir structure, code cleanliness and
                    appropriate build automation. A horribly hacky solution
                    would take an hour, max. A clean one, depending on your
                    definition of clean, 2 to 8 hours.
                  </p>
                  ...
                  <p className="pt-2">
                    2. We are really, really interested in your object-oriented
                    or functional design skills, so please craft the most
                  ...
                  <p className="pt-2">
                    ...
                    by popular Open Source projects in the language you’re
                    using.
                  </p>

                  <p className="pt-2">
                    4. You have to solve the problem in Ruby, Clojure, Java, Go
                    or any other language without using any external libraries
                    except for a testing library for Test-Driven Development
                    (TDD) — a simple console-based solution is all we expect.
                  </p>
                  ...
                  <p className="pt-2">
                    6. Please use Git for version control. Frequent commits are
                    a huge plus.
                  </p>
                  ...
                  <p className="pt-2">
                    8. Please write comprehensive unit tests/specs.
                    Additionally, it’s a huge plus if you test drive your code.
                  </p>
                  ...
                  <p className="pt-2">
                    ...
                    because they fail fizz buzz. In fact, it’s so effective,
                    from the very next round — our ‘code pairing round’ — we’re
                    done with filtration and shift over to the selection stages
                    of our process. If you want a quick reckoner on how we go
                    about our recruitment, check
                    <a
                  ...
                  <p className="py-2">
                    ...
                    to join our team. The same team that has helped GOJEK become
                    a Super App with an ecosystem aided by 2 million driver
                    partners and 400,000 merchant partners. But why GOJEK? My
                    colleague explains. Visit{" "}
