  ...
  render() {
    return (
      <div className="first-section">
        <Helmet>
          <title>
            GO-JEK Careers: Check out the current job openings at GO-JEK Tech
          </title>
          <meta
            data-react-helmet="true"
            property="og:title"
            content="GO-JEK Careers: Check out the current job openings at GO-JEK Tech"
          />
          <meta
            data-react-helmet="true"
            name="twitter:title"
          ...
          <meta
            data-react-helmet="true"
            name="description"
            content="GO-JEK is hiring the best and brightest of tech minds to build one of the world's most versatile and agile on-demand service apps."
          />
          <meta
            data-react-helmet="true"
