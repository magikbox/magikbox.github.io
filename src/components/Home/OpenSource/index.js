  ...
  return (
    <section className="py-5 bg-green">
      <div className="container">
        <h1 className="h2 pl-0 font-xl-l text-center text-white">
          {" "}
          {data.data.heading}{" "}
        </h1>
        ...
        <div className="d-none d-lg-block">
          <div
            id="opensourceCards"
            className="row justify-content-md-center pt-4 "
          >
        ...
        <Slider
          {...settings}
          className="d-lg-none row justify-content-md-center pt-4 custom-controls-dark"
        >
          {projects.map((project, key) => {
            if (key <= 3) {
              return <Card data={project} key={key} />
        ...
        {/* Tech Stack */}
        <h1 className="h2 pt-3 font-xl-l text-center text-white">
          {techStack.heading}
        </h1>
        <div className="container">
          <div className="row pl-2 justify-content-center align-items-center">
            {techStack.data.map((technology, key) => (
              <TechStack data={technology} key={key} />
            ))}
          </div>
        </div>
        {/* End Tech stack  */}
