        ...
        <div className="section-wrapper">
          <div className="section go-food-section">
            <div className="posting-headline">
              ...
              <div className="posting-categories">
                ...
                <div className="category-label">
                  ENGINEERING – MOBILE ENGINEERING |
                </div>
            ...
            <div className="postings-btn-wrapper">
              <a
                href="https://forms.gle/wLK9vH1zztyBpG6o7"
                target="_default"
              ...
              <a
                href="https://forms.gle/ZctrxfLzqjcwHwvb6"
                target="_default"
            ...
            <div>
              ...
              <ul className="posting-requirements plain-list">
                <ul className="go-food-list">
                  ...
                  <li>
                    Build delightful user-facing experiences with smooth
                    performance.
                  </li>
                  <li>
                    Mentor and provide feedback to colleagues, participate in
                    organisation building.
                  </li>
                  <li>
                    Participate in research trips to better understand
                    aspirations and pain points of our customers.
                  </li>
                </ul>
              </ul>
            </div>
              ...
              <ul>
                <ul className="go-food-list">
                  <li>
                    ...
                    testing and deploying large scale applications on the
                    Android stack.
                  </li>
                  <li>Deep understanding of the Android framework.</li>
                  <li>Experience developing in Java or Kotlin.</li>
                  <li>
                    Experienced with writing testable code and unit tests.
                  </li>
                  <li>
                    Attention to detail, particularly around software
                    engineering fundamentals, testing methodologies, and
                    quality.
                  </li>
                  <li>
                  ...
                  <li>
                    Prior experience of a food based product startups is a plus.
                  </li>
