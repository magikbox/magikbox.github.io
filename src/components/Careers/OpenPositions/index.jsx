  ...
  render() {
    ...
    return (
      <Element
        ...
        className="container roboto-regular"
      >
        {this.props.showHeadings && (
          <div>
            <div className="row justify-content-lg-start justify-content-center">
              <h1 className="h1 font-xl-l pt-5 raleway-extrabold">
                Open Positions
              </h1>
            </div>
            <div className="card-body pb-3 row">
              <div className="col-md-4 font-xs-l text-uppercase roboto-bold open-position-heading d-md-block d-none">
                Designation
              </div>
              <div className=" col-md-2 font-xs-l roboto-bold open-position-heading d-md-block d-none text-uppercase">
                City
              </div>
              <div className=" col-md-2 font-xs-l roboto-bold open-position-heading d-md-block d-none text-uppercase">
                Team
        ...
        {this.state.openPositions.length === 0 && (
          <div className="card border-0 mb-1 rounded-0">
            <div className="card-body pb-0 row">
              ...
              <button
                onClick={() => {}}
                className="btn btn-link text-green col-md-4 text-success text-right pt-0"
              >
        ...
        {this.props.showHeadings && (
          <h5 className="py-5 text-black font-xs-l">
            Your profile doesn't fit a box? Don't worry,{' '}
            ...
            <a onClick={this.handleClick}>
              <span
                className="text-green font-xs-l"
