        ...
        <div className="section-wrapper">
          <div className="section go-food-section">
            ...
            <div>
              ...
              locations Bangalore and Jakarta. GoFood being one of the largest
              online food delivery applications, the scale at which this team
              operates is phenomenal. GoFood has more than 300k merchants and
              more than 20 millions dishes listed on it’s platform.
            </div>
            <div>
              <br />
            </div>
            ...
            <div>
              ...
              Bangalore. In this role you will be responsible to develop, deploy
              and maintain large backend applications aimed at improving
              customer experience on GoFood. You will also be responsible for
              high availability and scalability of GoFood backend
              platform.&nbsp;
            </div>
          </div>
          <div className="section go-food-section">
            <div>
              ...
              <ul className="posting-requirements plain-list">
                <ul className="go-food-list">
                  <li>
                    You will be part of one of the biggest food delivery system
                    with high throughput and visible end user impact.&nbsp;
                  </li>
                  <li>
                    You should understand the user and their behaviour and will
                    continuously contribute to make their experience better with
                    each release.
                  </li>
                  <li>
            ...
            <div>
              ...
              <ul>
                <ul className="go-food-list">
                  ...
                  <li>
                    Experience in troubleshooting server performance &shy;memory
                    issues, GC tuning, resource leaks etc.
                  </li>
                  <li>Prior experience of product based startups is a plus.</li>
                  <li>
